...
import com.greendao.gen.FuncActiveBeanDao;
import com.greendao.gen.FuncBeanDao;
...
public class HMROpenHelper extends DaoMaster.OpenHelper {
    ...
    public void onUpgrade(Database db, int oldVersion, int newVersion) {
        //操作数据库的更新
        MigrationHelper.migrate(db,FuncBeanDao.class);
        MigrationHelper.migrate(db,FuncActiveBeanDao.class);
    }
