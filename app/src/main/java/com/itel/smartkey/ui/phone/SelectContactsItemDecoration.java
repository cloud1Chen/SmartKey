...
public class SelectContactsItemDecoration extends RecyclerView.ItemDecoration{
    ...
    public SelectContactsItemDecoration(Context context, int orientation) {
    ...
    public SelectContactsItemDecoration(Context context,int orientation,int resId)
    {
        this.mContext = context;
